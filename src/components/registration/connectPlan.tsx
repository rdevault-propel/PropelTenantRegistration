...
export default function ConnectPlan({ tenant, updateTenant, setStep }: ConnectPlanProps) {
  ...
  async function validateBeforeNext() {
    const newErrors: typeof errors = {
      ...
      organizationShortNameError: validateOrganizationShortName(
      ...
      <div className="flex flex-wrap gap-6 flex-1">
            ...
            <FieldGroup>
              <Field>
                ...
                {errors.numberOfUserLicensesError && (
                  <FieldError errors={[{ message: errors.numberOfUserLicensesError }]} />
                )}
              </Field>
        ...
        <Card className="relative mx-auto pt-5 flex-1 min-w-[400px]">
          ...
          <CardContent>
            <FieldGroup>
              ...
              <Field>
                ...
                <FieldDescription>
                  Short Name must be {MIN_ORG_SHORT_NAME} - {MAX_ORG_SHORT_NAME} letters to be used in member
                  registration and site access
                </FieldDescription>
                <Input
                ...
                {errors.organizationShortNameError && (
                  <FieldError errors={[{ message: errors.organizationShortNameError }]} />
                )}
              </Field>
              ...
              <Field>
                ...
                />
                {errors.contactPhoneNumberError && (
                  <FieldError errors={[{ message: errors.contactPhoneNumberError }]} />
                )}
              </Field>
            </FieldGroup>
          </CardContent>
          ...
          <CardFooter className="flex justify-between">
            ...
            <Button type="button" onClick={validateBeforeNext}>
              Continue To Payment
            </Button>
          </CardFooter>
        </Card>
