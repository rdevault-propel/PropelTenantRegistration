...
export default function ConnectSignup({ tenant, updateTenant, setStep }: ConnectSignupProps) {
      ...
      <CardContent>
        <FieldGroup>
          <Field>
            ...
            <FieldDescription>Name of the organization signing up</FieldDescription>
            <Input
          ...
          <Field>
            ...
            <FieldDescription>Primary contact who will administer the organization in Connect</FieldDescription>
            <Input
